\begin{titlepage}
	...
	\begin{center}
		...
		% \parbox so a title spanning several lines is broken while \LARGE is
		% still in effect and picks up its leading, as \maketitle does
		{\LARGE\sffamily\bfseries
			\parbox[t]{\textwidth}{\centering\thetitle{}}}\\[50pt]
